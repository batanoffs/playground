import iphonescreen from '../images/iphone-screen-with-shadow.png'
            ...
            <div className="container">
                ...
                <div className="col-md-12">
                    ...
                    <div className="row">
                        ...
                        <div className="feature-mobile"> <img src={iphonescreen} alt='example iphone look' className="img-fluid wow fadeInUp"/> </div>
                        </div>
                        <div className="col-md-4 col-sm-12">
                        <div className="media single-feature wow fadeInUp" data-wow-delay="0.2s">
