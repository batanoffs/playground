                ...
                <div className="section-content">
                    ...
                    <div className="offset-md-2 col-md-8 col-sm-12">
                        ...
                        <div className="slider-item">
                            <div className="test-img"><img src={user1} alt="Placeholder" width="157" height="157"/></div>
                        ...
                        <div className="slider-item">
                            <div className="test-img"><img src={user2} alt="Placeholder" width="157" height="157"/></div>
                        ...
                        <div className="slider-item">
                            <div className="test-img"><img src={user3} alt="Placeholder" width="157" height="157"/></div>
