...
describe("E2E tests", function () {
  ...
  describe('BONUS:Search Page [ 15 Points ]', async () => {
    ...
    it.only('Show no matches for Guest [ 2.5 Points ]', async () => {
    ...
    it.only('Show results with 2 fruits for Guest [ 2.5 Points ]', async () => {
    ...
    it.only('Show More info button for Guest [ 2.5 Points ]', async () => {
    ...
    it.only('Show no matches for Users [ 2.5 Points ]', async () => {
        // Login user
        const data = mockData.users[0];
        await page.goto(host);
        await page.waitForTimeout(interval);
    ...
    it.only('Show results with 2 fruit for Users [ 2.5 Points ]', async () => {
        // Login user
        const data = mockData.users[0];
        await page.goto(host);
        await page.waitForTimeout(interval);
    ...
    it.only('More Info info button for User [ 2.5 Points ]', async () => {
        // Login user
        const data = mockData.users[0];
        await page.goto(host);
        await page.waitForTimeout(interval);
